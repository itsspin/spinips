...
Inspired by WoW's **Narcissus** and tightened for v3, the Equipment tab is a compact cinematic composition - the window is now **660x700** (down from 780x800, with the remaining outer gutters tightened) with no information removed:
